            ...
            <p-panel #panel [collapsed]="true"
                ...
                <div [formGroupName]="config.key" *ngIf="childGroup">
                    <ng-template ngFor let-child [ngForOf]="config.children">
                        <div [jhiDynamicField]="child[0]" [context]="context" [group]="childGroup" styleClass="form-row mb-2"
                        ...
                        <ng-template #multiColumn>
                            <div class="form-row mb-2">
                                <div *ngFor="let grandChild of child; let i = index"
                                    ...
                                    <ng-container [jhiDynamicField]="child[i]" [group]="childGroup" [context]="context"
