    ...
    data.projections = [
      {
        'code': 'main',
        'active': false,
        'searchUrl': 'partnerdocuments/api/_search/bank-accounts',
        'actions': [
          [
        ...
        'columns': [
          {
            'field': 'infoTip',
            'header': 'partnerGatewayApp.partnerDocumentsEntity.infoTip',
          ...
          {
            'field': 'fullDocumentType',
            'header': 'partnerGatewayApp.partnerDocumentsEntity.fullDocumentType',
            'formatter': null,
        ...
        'label': 'partnerGatewayApp.partnerDocuments.tabs.inner',
        'filters': [],
        'loadActualInfo': null
      }
